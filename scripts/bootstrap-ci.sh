...
DEST_MODULE_DIR="$GITHUB_WORKSPACE/upstream/web/modules/packages/du_media_experts"

# Copy entire module into upstream/web/modules/packages/du_media_experts
...
# Enable modules
ddev drush en du_media_experts du_functional_testing -y
